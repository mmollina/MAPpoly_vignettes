...
```{r plot_full_mat, eval=TRUE, fig.width=10}
...
```{r reestimate_map_with_error, eval=TRUE}
...
<!-- ```{r batches_definition, eval=TRUE} -->
...
```{r, meiosis_evaluation, eval=TRUE}
