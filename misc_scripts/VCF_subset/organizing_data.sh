...
vcftools --vcf ~/repos/BT_map/data/vcf_sweetpotato_original/myGBSGenos_trifida_mergedSNPs_mergedTaxa_chr12.vcf --snps SNPs_ch12.txt --recode --recode-INFO-all --out selected_SNPs_ch12.vcf

python VCF2SM/VCF2SM.py -i ~/repos/BT_map/data/vcf_sweetpotato_original/myGBSGenos_trifida_mergedSNPs_mergedTaxa_chr3.vcf -o trifida_chr3.vcf -d 20 -a AD -g BT -1 Beauregard_BT -2 Tanzania_BT -S ./src/SuperMASSA.py -I f1 -M 2:6 -f 2:6 -p 0.80 -n 0.50 -c 0.50 -t 8 &
python VCF2SM/VCF2SM.py -i ~/repos/BT_map/data/vcf_sweetpotato_original/myGBSGenos_trifida_mergedSNPs_mergedTaxa_chr12.vcf -o trifida_chr12.vcf -d 20 -a AD -g BT -1 Beauregard_BT -2 Tanzania_BT -S ./src/SuperMASSA.py -I f1 -M 2:6 -f 2:6 -p 0.80 -n 0.50 -c 0.50 -t 8 &
